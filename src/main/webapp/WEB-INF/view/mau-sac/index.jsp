...
<a style="margin: 20px" href="/mau-sac/view-add" type="button"
...
<table class="table table-hover">
    ...
    <c:forEach items="${danhSach.content}" var="cv" varStatus="stt">
        <tr>
            ...
            <td>${cv.ten}</td>
            <td>
                <a href="/mau-sac/view-update/${cv.id}"
                   class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                <a href="/mau-sac/remove/${cv.id}"
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
        <li class="page-item">
            <a class="page-link" href="/mau-sac/hien-thi?page=1">Trước</a>
        </li>
        <c:forEach begin="0" end="${danhSach.totalPages -1}" varStatus="loop">
            <li class="page-item">
                <a class="page-link"
                   href="/mau-sac/hien-thi?page=${loop.index + 1}">${loop.index + 1}</a>
            </li>
        </c:forEach>
        <li class="page-item">
            <a class="page-link" href="/mau-sac/hien-thi?page=${danhSach.totalPages}">Sau</a>
        </li>
    </ul>
</nav>
